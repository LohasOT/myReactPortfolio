...
const Footer = () => {
  ...
  return (
    ...
    <footer id="foot" className="flex-row px-1">
        ...
        <a href="https://stackoverflow.com/users/17076160/lohas" rel="noopener noreferrer" target="_blank"><img src="https://img.icons8.com/stickers/100/000000/stackoverflow.png" alt='link' /></a>
    </footer>
    <br></br>
